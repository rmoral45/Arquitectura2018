...
set_property PACKAGE_PIN T2 [get_ports {i_i_sw[10]}]					
...
set_property PACKAGE_PIN W2 [get_ports {i_i_sw[12]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {i_sw[12]}]
set_property PACKAGE_PIN U1 [get_ports {i_i_sw[13]}]					
...
set_property PACKAGE_PIN N3 [get_ports {debug_led[0]}]					
set_property IOSTANDARD LVCMOS33 [get_ports {debug_led[0]}]
set_property PACKAGE_PIN P1 [get_ports {debug_led[1]}]					
...
#set_property PACKAGE_PIN V7 [get_ports dp]							3set_property IOSTANDARD LVCMOS33 [get_ports dp]
...
set_property PACKAGE_PIN W19 [get_ports i_btnL]						
set_property IOSTANDARD LVCMOS33 [get_ports i_btnL]
set_property PACKAGE_PIN T17 [get_ports i_btnR]						
set_property IOSTANDARD LVCMOS33 [get_ports i_btnR]
set_property PACKAGE_PIN U17 [get_ports i_btnD]						
