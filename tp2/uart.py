...
def main():
	...
	while True:
		...
		#ope2 = raw_input("Ahora, ingrese el primer operando, recuerde que el tamanio de palabra es de 8 bits: ")
		#ope2 = int(ope1)
		...
		"""
		print 'CARACTER ENVIADO' , bin(ope1), chr(ope1)
		sent = ser.write(ope1)  # envio op1, op2, opcode
		#sent = ser.write(chr(ope2))
		#sent = ser.write(chr(operador))

		#out_fpga = ser.read()  # leo salida de placa
		#print 'El resultado es: ', ord(out_fpga)
